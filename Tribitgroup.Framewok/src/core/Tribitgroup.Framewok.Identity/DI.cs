...
namespace Tribitgroup.Framewok.Identity
{
    public static class DI
    {
        ...
        private static void AddPostAuthenticationMiddleware(WebApplication app)
        {
            ...
            JwtSecurityToken CreateToken(List<Claim> authClaims, JwtSetting _jwtSetting)
            {
            ...
            ClaimsPrincipal? GetPrincipalFromExpiredToken(string? token, JwtSetting jwtSetting)
            {
